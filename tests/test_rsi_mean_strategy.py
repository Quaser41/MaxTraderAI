...
def test_rsi_mean_reversion(monkeypatch):
    ...
    df_buy = make_df(list(range(100, 80, -1)))
    df_sell = make_df(list(range(100, 120)))

    bot = TraderBot(Config(symbol="T-USD", strategy="rsi_mean"))
